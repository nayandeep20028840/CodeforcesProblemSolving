...
void solve(){
    ...
    //cout<<s[n]<<endl;
    //cout<<n<<endl;
    if(s[n-1]=='A'){ cout<<"NO"<<endl;return;}
    if(s[0]=='B'){ cout<<"NO"<<endl;return;}
    if(n==1){cout<<"NO"<<endl;return;}
    if(n==2 && s[0]=='A' && s[1]=='B'){ cout<<"YES"<<endl;return;}
    if(n==2 && s[0]=='B'){ cout<<"NO"<<endl;return;}
    int c=0;
    for(int i=0;i<n;i++){
        if(s[i]=='B'){
            c++;
    ...
    if(c==1 && s[n-1]=='B'){cout<<"YES"<<endl;return;}
    if(c==1 && s[n-1]!='B'){cout<<"NO"<<endl;return;}
    if(c>2){
        cout<<"NO"<<endl;
        return;
    }
