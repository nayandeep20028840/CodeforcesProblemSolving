...
//  if(x > 1 && y > 1){
//             if(abs((x - 1) - u) + abs((y - 1) - v) == 1) c1 = 1 ;
//             if(abs((x) - u) + abs((y - 1) - v) == 1) c2 = 1 ;
//             if(abs((x - 1) - u) + abs((y) - v) == 1) c3 = 1 ;
//         }
//         if(x == 1 && y > 1){
//             if(abs((x) - u) + abs((y - 1) - v) == 1) c2 = 1 ;
//         }else{
...
//         }
//         if(x < n && y < m){
//             if(abs((x + 1) - u) + abs((y + 1) - v) == 1) c4 = 1 ;
//         }else{
//             c4 = 1 ;
//         }
//         if(x == n && y < m){
//             if(abs((x) - u) + abs((y + 1) - v) == 1) c5 = 1 ;
//         }else{
//             c5 = 1 ;
//         }
//         if(x < n && y == m){
//             if(abs((x + 1) - u) + abs((y) - v) == 1) c6 = 1 ;
//         }else{
//             c6 = 1 ;
//         }