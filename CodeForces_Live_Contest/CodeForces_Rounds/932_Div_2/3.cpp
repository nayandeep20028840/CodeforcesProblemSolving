...
bool comparatorfunction1(pair<int, int> &a, pair<int, int> &b)
{
    if (a.F != b.F)
    {
        return a.F < b.F;
...
bool comparatorfunction2(pair<int, int> &a, pair<int, int> &b)
{
    if (a.F != b.F)
    {
        return a.F > b.F;
...
bool comparatorfunction3(pair<int, int> &a, pair<int, int> &b)
{
    if (a.F != b.F)
    {
        return a.F > b.F;
...
bool solve(){
    ...
    sort(all(p),comparatorfunction1);
    for(int i=0;i<n;++i){
        int sum=0;
        sum+=p[i].F;
        int mx=0;
    ...
    sort(all(p),comparatorfunction2);
    for(int i=0;i<n;++i){
        int sum=0;
        sum+=p[i].F;
        int mx=0;
    ...
    sort(all(p),comparatorfunction3);
    for(int i=0;i<n;++i){
        int sum=0;
        sum+=p[i].F;
        int mx=0;
