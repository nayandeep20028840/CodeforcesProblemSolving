...
bool solve(){
    int n , k , g ;
    cin >> n >> k >> g ;
    // if(n >= (k * g)){ // we can 0 to astrophysicist // test case failed 3 1 2 // 0 1 1
    //     cout << k * g << nl ;
    //     return true ;
    // } // make a single formula for every case 
    // only make extra if statement for n == 1 or k == 1
    // if(g == 2 || g == 3){
    //     cout << 0 << nl ;
    //     return true ;
    // }
