...
bool solve(){
    ...
    function<int(int,int,int,int)> func=[&](int i,int ft , int sc , int th)->int{
        if(i >= n) return 0 ;
        if(dp[i][ft][sc][th] != -1) return dp[i][ft][sc][th] ;
        int ans = 0 ;
        if(ft == 0 and sc == 0 and th == 0) {
            ans = max({ans , func(i + 1 , 1 , sc , th) + a[i] , func(i + 1 , ft , 1 , th) + b[i] , func(i + 1 , ft , sc , 1) + c[i] , func(i + 1 , ft , sc , th)}) ;
        }
        else if(ft == 1 and sc == 0 and th == 0) {
            ans = max({ans , func(i + 1 , ft , 1 , th) + b[i] , func(i + 1 , ft , sc , 1) + c[i] , func(i + 1 , ft , sc , th)}) ;
        }
        else if(ft == 0 and sc == 1 and th == 0) {
            ans = max({ans , func(i + 1 , 1 , sc , th) + a[i] , func(i + 1 , ft , sc , 1) + c[i] , func(i + 1 , ft , sc , th)}) ;
        }
        else if(ft == 0 and sc == 0 and th == 1) {
            ans = max({ans , func(i + 1 , 1 , sc , th) + a[i] , func(i + 1 , ft , 1 , th) + b[i] , func(i + 1 , ft , sc , th)}) ;
        }
        else if(ft == 1 and sc == 1 and th == 0) {
            ans = max({ans , func(i + 1 , ft , sc , 1) + c[i] , func(i + 1 , ft , sc , th)}) ;
        }
        else if(ft == 1 and sc == 0 and th == 1) {
            ans = max({ans , func(i + 1 , ft , 1 , th) + b[i] , func(i + 1 , ft , sc , th)}) ;
        }
        else if(ft == 0 and sc == 1 and th == 1) {
            ans = max({ans , func(i + 1 , 1 , sc , 1) + a[i] , func(i + 1 , ft , sc , th)}) ;
        }
        else if(ft == 1 and sc == 1 and th == 1) {
            ans = max({ans , func(i + 1 , ft , sc , th)}) ;
        }
        return dp[i][ft][sc][th] = ans ;
    };
    cout << func(0 , 0 , 0 , 0) << nl ;
    return true ;
}
