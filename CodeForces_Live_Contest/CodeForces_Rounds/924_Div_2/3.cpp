...
bool solve(){
    ...
    cin >> n >>  x ;
    set<int > s ;
    for(int i = 2 ; i <= sqrtl(n + x - 2) ; ++i){
        if((n + x) % (2 * i - 2) == 0 and x <= i){
            s.insert(i) ;
        }
    }
    if(x != 1)
    for(int i = 2 ; i <= sqrtl(n - x) ; ++i){
        if((n - x) % (2 * i - 2) == 0 and x <= i){
            s.insert(i) ;
        }
    }
...
//     int ans = 0 ;
//     // cout <<rem << nl;
//     for(int i = 1 ; i <= sqrtl(rem) ; ++i){
//         if(i == 1){
//             int div = rem ;
//             if(div == 2){
//                 if(div and rem % div == 0){
//                     ans += 1 ;
//                 }
//             }
//             else{
//                 if((div + div - 2) and rem % (div + div - 2) == 0){
//                     ans += 1 ;
//                 }
//             }
//         }
