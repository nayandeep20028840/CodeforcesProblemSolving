...
bool solve(){
    ...
    for(auto &i : primes){
        ...
        sum += num ;
            ...
            if(k % (i * i * i) == 0){
                if(i == k / (i * i * i)) continue ;
                if((k / i) == k / (i * i * i)) continue ;
                if((k / (i * i)) == k / (i * i * i)) continue ;
                int sum2 = (k / (i * i * i)) ;
                int num2 = sum2 * sum2 ;
                sum2 += num2 ;
                while(sum2 <= k && k % (k / (i * i * i)) == 0){
                    if(sum2 == k) {
                        yes
                        return true ;
                    }
            ...
            if(k % (i * i * i * i) == 0){
                if(i == k / (i * i * i * i)) continue ;
                if((k / i) == k / (i * i * i * i)) continue ;
                if((k / (i * i)) == k / (i * i * i * i)) continue ;
                if((k / (i * i * i)) == k / (i * i * i * i)) continue ;
                int sum2 = (k / (i * i * i * i)) ;
                int num2 = sum2 * sum2 ;
                sum2 += num2 ;
                while(sum2 <= k && k % (k / (i * i * i * i)) == 0){
                    if(sum2 == k) {
                        yes
                        return true ;
                    }
