...
bool solve(){
    ...
    cin>>n;
    if(n==12) cout<<8<<nl;
    else if(n==11) cout<<6<<nl;
    else if(n==10) cout<<9<<nl;
    else if(n==9) cout<<0<<nl;
    else if(n==8) cout<<7<<nl;
    else if(n==7) cout<<7<<nl;
    else if(n==6) cout<<7<<nl;
    else if(n==5) cout<<7<<nl;
    else if(n==4) cout<<8<<nl;
    else if(n==3) cout<<9<<nl;
    else if(n==2) cout<<8<<nl;
    else if(n==1) cout<<10<<nl;
    else cout<<10<<nl;
    return true ;
}
