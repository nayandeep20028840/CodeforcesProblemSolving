...
bool solve(){
    ...
    int j = 0 ;
    for(int i = 0 ; i < n ; ++i){
        if(v[i] == 0 && i != 0 && i != (n - 1) && !extra.empty()){
            ans.pb(extra) ;
            j ++ ;
            extra.clear() ;
        }
    ...
    for(auto &i : ans){
        ...
        if(neg % 2 == 0){
            ...
            // cout << front << " " << back << nl ;
            mx = max(mx , count_two - min(front , back)) ;
        }
        // cout << mx << nl ;
    }
    int maximum = -1e9 ;
    ...
    for(auto &i : ans){
        ...
        if(neg % 2 == 0){
            ...
            maximum = max(maximum , count_two - min(front , back)) ;
        }
        delete_back = len - (delete_back) ;
        if(mx == maximum){
            answer_front += len ;
            int answer_back = 0 ;
            int real_answer_front = 0 ;
            // cout << front << " " << back << nl ;
            // cout << answer_front << " " << answer_back << nl ;
            // cout << delete_front << " " << delete_back << nl ;
            if(front < back){
                answer_back = n - answer_front ;
                real_answer_front = answer_front - len + delete_front ;
            }
            else{
                answer_back = n - answer_front + delete_back ;
                real_answer_front += answer_front - len ;
            }
            cout << real_answer_front << " " << answer_back << nl ;
            break;
        }else{
            answer_front += len + 1 ;
        }
