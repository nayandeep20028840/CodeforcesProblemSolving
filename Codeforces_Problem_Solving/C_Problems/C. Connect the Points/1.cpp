...
bool solve(){
    ...
    sort(p.begin(),p.end());
    cout<<3<<nl;
    cout<<p[1].first<<" "<<max({p[0].second,p[1].second,p[2].second})<<" "<<p[1].first<<" "<<min({p[0].second,p[1].second,p[2].second})<<nl;
    cout<<p[0].first<<" "<<p[0].second<<" "<<p[1].first<<" "<<p[0].second<<nl;
    cout<<p[2].first<<" "<<p[2].second<<" "<<p[1].first<<" "<<p[2].second<<nl;
    return true ;
}
