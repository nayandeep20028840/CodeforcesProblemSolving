...
bool solve(){
    ...
    int mn2 = INF ;
    int mn3 = INF ;
    mn1 = abs(r1 - r2) + abs(r1 - r3) + abs(c1 - c2) + abs(c1 - c3) ;
    mn2 = abs(r1 - r2) + abs(r2 - r3) + abs(c1 - c2) + abs(c2 - c3) ;
    mn3 = abs(r3 - r2) + abs(r1 - r3) + abs(c3 - c2) + abs(c1 - c3) ;
    // cout << r1 << " " << c1 << nl ;
