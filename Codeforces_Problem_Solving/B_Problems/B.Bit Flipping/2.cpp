...
bool solve(){
    ...
    if(k == 1){
        int index = 0;
        for(int i = 0 ; i < n ; ++i){if(s[i] == '1'){index = i;break;}}
        for(int i = 0 ; i < n ; ++i){if(i == index) {cout << 1; continue;} if(s[i] == '1'){cout << 0;}else{cout << 1;} } cout << endl;         
        for(int i = 0 ; i < index ; ++i){cout << 0 << " " ;}cout << 1 << " " ;
        for(int i = index + 1 ; i < n ; ++i) cout << 0 << " "; cout << endl;
        return true;
    }
    int zero = 0;
    ...
    if(k % 2 == 0){
        ...
        if(k >= zero){
            ...
            for(int i = 0 ; i < n - zero + ok ; ++i){
                cout << 1;
            }
            for(int i = zero - ok ; i > 0 ; --i){
                cout << 0;
            }
            cout << endl;
            ok = k;
