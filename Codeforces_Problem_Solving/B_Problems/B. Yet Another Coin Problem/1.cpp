...
bool solve(){
    ...
    if(n<15) cout<<v[n%15]<<nl;
    else if(n%15==5) cout<<n/15+1<<nl;
    else if(n%15==8) cout<<n/15+2<<nl;
    else if(n%15==10) cout<<n/15+1<<nl;
    else if(n%15==13) cout<<n/15+2<<nl;
    else if(n%15==14) cout<<n/15+3<<nl;
    else cout<<n/15+v[n%15]<<nl;
    return true ;
}
