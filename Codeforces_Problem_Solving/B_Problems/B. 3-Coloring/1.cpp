...
bool solve(){
    ...
    multiset<pair<int,int>>ones;
    multiset<pair<int,int>>twos;
    int turn=1;
    for(int i=0;i<n;++i){
        for(int j=0;j<n;++j){
            mat[i][j]=turn;
    ...
    for(int i=1;i<=n*n;++i){
        ...
        if(a==3){
            if(ones.size()>twos.size()){
                cout<<1<<" "<<(*(ones.begin())).F<<" "<<(*(ones.begin())).S<<endl;
                ones.erase(ones.begin());
            }
            else if(ones.size()<twos.size()){
                cout<<2<<" "<<(*(twos.begin())).F<<" "<<(*(twos.begin())).S<<endl;
            ...
            if(ones.size()){
                ...
                cout<<3<<" "<<(*(twos.begin())).F<<" "<<(*(twos.begin())).S<<endl;
                twos.erase(twos.begin());
            }
        }
        else{
            if(twos.size()){
                ...
                cout<<3<<" "<<(*(ones.begin())).F<<" "<<(*(ones.begin())).S<<endl;
                ones.erase(ones.begin());
            }
        }
    }
